...
// ── CHANGE THIS ───────────────────────────────────────────────────────────────
const BOOKING_ID = "4ca156ad-b7ff-425e-a7cd-6b65f23be57e";
// ─────────────────────────────────────────────────────────────────────────────

const feedback = {
  summary:
    "Nishith demonstrated a solid understanding of React fundamentals and component architecture. He approached problems methodically and showed good instincts around state management. With some refinement in system design and async patterns, he's well on track for a mid-level frontend role.",
  technical:
  ...
  sessionRating: 4,
  sessionComment:
    "Great session — Nishith was engaged and receptive to feedback. Would be happy to interview him again after he's done more system design prep.",
};
